function parseUplink(device, payload) {
    ...
    if (parsed[0] && parsed[0].payload && parsed[0].payload.variables) {
        ...
        if (variables[0] != null && e2 != null) {
            e2.updateTemperatureSensorStatus(variables[0].temperatureCelsius2); //Temperatura Retorno ACS
            }
        if (variables[0] != null && e3 != null) {
            e3.updateTemperatureSensorStatus(variables[0].temperatureCelsius3); //Temperatura Agua Fría
            }
        ...
        if (variables[0] != null && e10 != null) {
            e10.updateGenericSensorStatus(variables[0].mp1);
            //e10.accessType = endpointAccessType.readOnly;
            
            }
        if (variables[0] != null && e11 != null) {
            e11.updateGenericSensorStatus(variables[0].mp2)
            //e11.updateApplianceStatus(variables[0].mp2);
            }
        if (variables[0] != null && e12 != null) {
            e12.updateGenericSensorStatus(variables[0].mp3);
            }
        if (variables[0] != null && e13 != null) {
            e13.updateGenericSensorStatus(variables[0].mp4);
            }
        if (variables[0] != null && e14 != null) {
            e14.updateGenericSensorStatus(variables[0].mp5);
            }
        if (variables[0] != null && e15 != null) {
            e15.updateGenericSensorStatus(variables[0].mp6);
            }
        if (variables[0] != null && e16 != null) {
            e16.updateGenericSensorStatus(variables[0].mp7);
            }
        if (variables[0] != null && e17 != null) {
            e17.updateGenericSensorStatus(variables[0].mp8);
            }
        if (variables[0] != null && e18 != null) {
            e18.updateGenericSensorStatus(variables[0].mp9);
            }
        if (variables[0] != null && e19 != null) {
            e19.updateGenericSensorStatus(variables[0].mp10);
            }
        if (variables[0] != null && e20 != null) {
            e20.updateGenericSensorStatus(variables[0].mp11);
            }
        if (variables[0] != null && e21 != null) {
            e21.updateGenericSensorStatus(variables[0].mp12);
            }
        if (variables[0] != null && e22 != null) {
           e22.updateGenericSensorStatus(variables[0].mp13);
            }
    ...
    if (parsed[0] && parsed[0].payload2 && parsed[0].payload2.variables) {
        var variables2 = parsed[0].payload2.variables;

        var e23 = device.endpoints.byAddress("23"); //Viene de Vestuario de Fútbol
        env.log(variables2[0]);
    
        if (variables2[0] != null && e23 != null) {
            e23.updateTemperatureSensorStatus(variables2[0].temperatureCelsius10);
            }
